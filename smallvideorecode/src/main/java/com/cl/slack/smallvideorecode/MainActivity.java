package com.cl.slack.smallvideorecode;
...
import static com.cl.slack.smallvideorecode.R.id.et_crfSize;
import static com.cl.slack.smallvideorecode.R.id.rb_no_compress;
...
//                        .setVelocity(BaseMediaBitrateConfig.Velocity.ULTRAFAST)
    ...
    public static void initSmallVideo(Context context) {
        ...
        if (DeviceUtils.isZte()) {
            if (dcim.exists()) {
                VCamera.setVideoCachePath(dcim + "/slack/");
            } else {

...
public class SurfaceEncoder {
    ...
    public SurfaceEncoder(String descPath) {
        OUT_PUT_PATH = descPath;
        new File(OUT_PUT_PATH);
    }
    ...
    public void VideoEncodePrepare() {
        ...
        try {
            ...
            encoder.start();
            mMuxer = new MediaMuxer(OUT_PUT_PATH, MediaMuxer.OutputFormat.MUXER_OUTPUT_MPEG_4);
